...
function EditLocation() {
  ...
  const fetchLocation = async () => {
    const res = await axios.get(`/locations/${id}.json`);
  ...
  const handleDelete = async () => {
    await axios.delete(`/locations/${location.id}.json`);
    setOpen(false);
    navigate("/locations");
  };
  ...
  const processSubmit = async (values, setSubmitting) => {
    try {
      await axios.patch(`/locations/${id}.json`, {
        location: {
          ...values,
        },
      });
  ...
  return loading ? (
    ...
    <>
        ...
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <FormHelperText>
                Enter an address for the location.
              </FormHelperText>
              {!!errors.address && (
                <FormErrorMessage>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <DialogContentText>
            This will archive the location and remove it from your locations.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
